...
public class TransferController {
    ...
    public ResponseEntity<List<TransferResponse>> batchTransfer(@RequestBody @Valid @Size(min = 1, max = 20) List<TransferRequest> reqs) {
        return ResponseEntity.ok(transferService.batchTransfer(reqs));
    }
}
